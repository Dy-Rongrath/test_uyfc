...
@Component({
    ...
    standalone   : true,
    imports      : [NgIf, EmptyLayoutComponent, DenseLayoutComponent],
})
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'helpers-version', HELPERS_VERSION);

        // Set the OS name
        this._renderer2.addClass(this._document.body, this._helpersPlatformService.osName);
    }
