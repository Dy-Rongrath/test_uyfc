...
import { FSDocument, FSDocumentElement } from 'helpers/components/fullscreen/interface';

@Component({
    selector       : 'helpers-fullscreen',
    templateUrl    : './template.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'helpersFullscreen',
    standalone     : true,
    imports        : [MatButtonModule, MatTooltipModule, NgTemplateOutlet, MatIconModule],
})
export class HelpersFullscreenComponent implements OnInit
{
